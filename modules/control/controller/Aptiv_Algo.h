 ...
 */
class Aptiv_AlgoController : public Controller {
 public:
  /**
   * @brief constructor
   */
  Aptiv_AlgoController();

  /**
   * @brief destructor
   */
  virtual ~Aptiv_AlgoController();
 ...
 private:
  void SetDigitalFilterPitchAngle(const Aptiv_AlgoConf &Aptiv_Algo_conf);
